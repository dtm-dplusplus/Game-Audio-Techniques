	...
	public class FirstPersonController : MonoBehaviour
	{
        ...
        private void Move()
        {
            ...
            if (_input.move == Vector2.zero)
            {
                ...
                // If Stopped moving. Reset footstep Timer
            ...
            if (_input.move != Vector2.zero)
            {
                ...
                // When moving tick down timer
                if (Grounded) _footStepTimer -= Time.deltaTime;
            }
        ...
        private void Footsteps()
		{
            ...
            if (_footStepTimer <= 0.0f)
            {
                ...
                AudioSource.pitch = 1 + (_pitchToggle ? PitchDifference : -PitchDifference);
